...
class ContractService:
    ...
    def create_contract(self, sale_contact:int, total_amount:int, amount_remaining_paid:int, customer_informations:str, status:str) -> object:
        contract = Contract(sale_contact=sale_contact, total_amount=total_amount, amount_remaining_paid=amount_remaining_paid, customer_informations=customer_informations, status=status)
    ...
    def update_contract(self,id__:int, sale_contact_to_change:int, total_amount_to_change:int, amount_remaining_paid_to_change:int, customer_informations_to_change:str, status_to_change:str):
        return self.repository.update_contract(id__,sale_contact_to_change,total_amount_to_change,amount_remaining_paid_to_change, customer_informations_to_change, status_to_change)
