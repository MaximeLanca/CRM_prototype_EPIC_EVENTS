...
class ContractRepository(ABC):
    ...
    @abstractmethod
    def update_contract(self, contract_id:int,  sale_contact_to_change:int, total_amount_to_change:int, amount_remaining_paid_to_change:int, customer_informations_to_change:str, status_to_change:str) -> None:
        pass
...
class UserRepository(ABC):
    ...
    @abstractmethod
    def update_user_information(self, user_id:int, name_to_change, role_to_change) -> None:
        pass
