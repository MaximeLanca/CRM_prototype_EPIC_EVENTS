...
class EventController:
    ...
    def create_event(self, contract:int, date_start:datetime, date_end:datetime, support_contact:int, location:str, attendee:int, note:str) -> object:
        return self.service.create_event(contract, date_start, date_end, support_contact, location, attendee, note)
    ...
    def update_event(self, event_id:int, contract_to_change:int, date_start_to_change:datetime, date_end_to_change:datetime, support_contact_to_change:int, location_to_change:str, attendee_to_change:int, note_to_change:str):
        return self.service.update_event(event_id, contract_to_change, date_start_to_change, date_end_to_change, support_contact_to_change, location_to_change, attendee_to_change, note_to_change)
    
    def filter_event(self, support_contact:int):
        return self.service.filter_event(support_contact)
