...
class UserController:
    ...
    def update_user_information(self,user_id:int, name_to_change:str, role_to_change:str):
        return self.service.update_user_information(user_id,name_to_change,role_to_change)